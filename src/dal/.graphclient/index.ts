...
export type LpStakingPositionResolvers<ContextType = MeshContext, ParentType extends ResolversParentTypes['LpStakingPosition'] = ResolversParentTypes['LpStakingPosition']> = ResolversObject<{
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  user?: Resolver<ResolversTypes['User'], ParentType, ContextType>;
  pair?: Resolver<ResolversTypes['Pair'], ParentType, ContextType>;
...
export type PairResolvers<ContextType = MeshContext, ParentType extends ResolversParentTypes['Pair'] = ResolversParentTypes['Pair']> = ResolversObject<{
  ...
  maxReserveRatio?: Resolver<ResolversTypes['BigInt'], ParentType, ContextType>;
  ...
  whitelist?: Resolver<Array<ResolversTypes['PairWhitelist']>, ParentType, ContextType, RequireFields<PairwhitelistArgs, 'skip' | 'first'>>;
  allocationPoints?: Resolver<ResolversTypes['BigInt'], ParentType, ContextType>;
  ...
  pairReserves?: Resolver<Array<ResolversTypes['PairReserve']>, ParentType, ContextType, RequireFields<PairpairReservesArgs, 'skip' | 'first'>>;
...
export type PairReserveResolvers<ContextType = MeshContext, ParentType extends ResolversParentTypes['PairReserve'] = ResolversParentTypes['PairReserve']> = ResolversObject<{
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  pair?: Resolver<ResolversTypes['Pair'], ParentType, ContextType>;
...
export type PairWhitelistResolvers<ContextType = MeshContext, ParentType extends ResolversParentTypes['PairWhitelist'] = ResolversParentTypes['PairWhitelist']> = ResolversObject<{
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  token?: Resolver<ResolversTypes['Token'], ParentType, ContextType>;
  pair?: Resolver<ResolversTypes['Pair'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
...
export type QueryResolvers<ContextType = MeshContext, ParentType extends ResolversParentTypes['Query'] = ResolversParentTypes['Query']> = ResolversObject<{
  ...
  pairWhitelist?: Resolver<Maybe<ResolversTypes['PairWhitelist']>, ParentType, ContextType, RequireFields<QuerypairWhitelistArgs, 'id' | 'subgraphError'>>;
  pairWhitelists?: Resolver<Array<ResolversTypes['PairWhitelist']>, ParentType, ContextType, RequireFields<QuerypairWhitelistsArgs, 'skip' | 'first' | 'subgraphError'>>;
  pairReserve?: Resolver<Maybe<ResolversTypes['PairReserve']>, ParentType, ContextType, RequireFields<QuerypairReserveArgs, 'id' | 'subgraphError'>>;
  pairReserves?: Resolver<Array<ResolversTypes['PairReserve']>, ParentType, ContextType, RequireFields<QuerypairReservesArgs, 'skip' | 'first' | 'subgraphError'>>;
  tokenomicsParams?: Resolver<Maybe<ResolversTypes['TokenomicsParams']>, ParentType, ContextType, RequireFields<QuerytokenomicsParamsArgs, 'id' | 'subgraphError'>>;
  tokenomicsParams_collection?: Resolver<Array<ResolversTypes['TokenomicsParams']>, ParentType, ContextType, RequireFields<QuerytokenomicsParams_collectionArgs, 'skip' | 'first' | 'subgraphError'>>;
  lpStakingPosition?: Resolver<Maybe<ResolversTypes['LpStakingPosition']>, ParentType, ContextType, RequireFields<QuerylpStakingPositionArgs, 'id' | 'subgraphError'>>;
  lpStakingPositions?: Resolver<Array<ResolversTypes['LpStakingPosition']>, ParentType, ContextType, RequireFields<QuerylpStakingPositionsArgs, 'skip' | 'first' | 'subgraphError'>>;
  vrswStakingPosition?: Resolver<Maybe<ResolversTypes['VrswStakingPosition']>, ParentType, ContextType, RequireFields<QueryvrswStakingPositionArgs, 'id' | 'subgraphError'>>;
  vrswStakingPositions?: Resolver<Array<ResolversTypes['VrswStakingPosition']>, ParentType, ContextType, RequireFields<QueryvrswStakingPositionsArgs, 'skip' | 'first' | 'subgraphError'>>;
...
export type SubscriptionResolvers<ContextType = MeshContext, ParentType extends ResolversParentTypes['Subscription'] = ResolversParentTypes['Subscription']> = ResolversObject<{
  ...
  pairWhitelist?: SubscriptionResolver<Maybe<ResolversTypes['PairWhitelist']>, "pairWhitelist", ParentType, ContextType, RequireFields<SubscriptionpairWhitelistArgs, 'id' | 'subgraphError'>>;
  pairWhitelists?: SubscriptionResolver<Array<ResolversTypes['PairWhitelist']>, "pairWhitelists", ParentType, ContextType, RequireFields<SubscriptionpairWhitelistsArgs, 'skip' | 'first' | 'subgraphError'>>;
  pairReserve?: SubscriptionResolver<Maybe<ResolversTypes['PairReserve']>, "pairReserve", ParentType, ContextType, RequireFields<SubscriptionpairReserveArgs, 'id' | 'subgraphError'>>;
  pairReserves?: SubscriptionResolver<Array<ResolversTypes['PairReserve']>, "pairReserves", ParentType, ContextType, RequireFields<SubscriptionpairReservesArgs, 'skip' | 'first' | 'subgraphError'>>;
  tokenomicsParams?: SubscriptionResolver<Maybe<ResolversTypes['TokenomicsParams']>, "tokenomicsParams", ParentType, ContextType, RequireFields<SubscriptiontokenomicsParamsArgs, 'id' | 'subgraphError'>>;
  tokenomicsParams_collection?: SubscriptionResolver<Array<ResolversTypes['TokenomicsParams']>, "tokenomicsParams_collection", ParentType, ContextType, RequireFields<SubscriptiontokenomicsParams_collectionArgs, 'skip' | 'first' | 'subgraphError'>>;
  lpStakingPosition?: SubscriptionResolver<Maybe<ResolversTypes['LpStakingPosition']>, "lpStakingPosition", ParentType, ContextType, RequireFields<SubscriptionlpStakingPositionArgs, 'id' | 'subgraphError'>>;
  lpStakingPositions?: SubscriptionResolver<Array<ResolversTypes['LpStakingPosition']>, "lpStakingPositions", ParentType, ContextType, RequireFields<SubscriptionlpStakingPositionsArgs, 'skip' | 'first' | 'subgraphError'>>;
  vrswStakingPosition?: SubscriptionResolver<Maybe<ResolversTypes['VrswStakingPosition']>, "vrswStakingPosition", ParentType, ContextType, RequireFields<SubscriptionvrswStakingPositionArgs, 'id' | 'subgraphError'>>;
  vrswStakingPositions?: SubscriptionResolver<Array<ResolversTypes['VrswStakingPosition']>, "vrswStakingPositions", ParentType, ContextType, RequireFields<SubscriptionvrswStakingPositionsArgs, 'skip' | 'first' | 'subgraphError'>>;
...
export type TokenomicsParamsResolvers<ContextType = MeshContext, ParentType extends ResolversParentTypes['TokenomicsParams'] = ResolversParentTypes['TokenomicsParams']> = ResolversObject<{
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  ...
  lpShareFactor?: Resolver<ResolversTypes['BigDecimal'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;
...
export type UserResolvers<ContextType = MeshContext, ParentType extends ResolversParentTypes['User'] = ResolversParentTypes['User']> = ResolversObject<{
  ...
  lpStakingPositions?: Resolver<Maybe<Array<ResolversTypes['LpStakingPosition']>>, ParentType, ContextType, RequireFields<UserlpStakingPositionsArgs, 'skip' | 'first'>>;
  vrswStakingPositions?: Resolver<Maybe<Array<ResolversTypes['VrswStakingPosition']>>, ParentType, ContextType, RequireFields<UservrswStakingPositionsArgs, 'skip' | 'first'>>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;

export type VrswStakingPositionResolvers<ContextType = MeshContext, ParentType extends ResolversParentTypes['VrswStakingPosition'] = ResolversParentTypes['VrswStakingPosition']> = ResolversObject<{
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  user?: Resolver<ResolversTypes['User'], ParentType, ContextType>;
  amount?: Resolver<ResolversTypes['BigDecimal'], ParentType, ContextType>;
  lockDue?: Resolver<ResolversTypes['BigInt'], ParentType, ContextType>;
  discountFactor?: Resolver<ResolversTypes['BigDecimal'], ParentType, ContextType>;
...
const graphTestHandler = new GraphqlHandler({
              name: "graph-test",
              config: {"endpoint":"https://api.studio.thegraph.com/query/65471/graph-test/version/latest"},
              baseDir,
              cache,
              pubsub,
...
export type MetadataQuery = { _meta?: Maybe<{ block: Pick<_Block_, 'number' | 'timestamp'> }> };

export type PairsQueryVariables = Exact<{ [key: string]: never; }>;


export type PairsQuery = { pairs: Array<(
    Pick<Pair, 'id' | 'balance0' | 'balance1' | 'fee' | 'vFee' | 'maxReserveRatio' | 'reserveRatio' | 'blocksDelay' | 'lastSwapBlock'>
    & { token0: Pick<Token, 'id' | 'decimals'>, token1: Pick<Token, 'id' | 'decimals'>, whitelist: Array<{ token: Pick<Token, 'id' | 'decimals'> }>, pairReserves: Array<(
...
export function getSdk<C, E>(requester: Requester<C, E>) {
  return {
    Metadata(variables?: MetadataQueryVariables, options?: C): Promise<MetadataQuery> {
      return requester<MetadataQuery, MetadataQueryVariables>(MetadataDocument, variables, options) as Promise<MetadataQuery>;
    },
