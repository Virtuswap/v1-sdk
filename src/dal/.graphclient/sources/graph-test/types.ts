...
export type _SubgraphErrorPolicy_ =
  ...
  /** null **/
  pairWhitelist: InContextSdkMethod<Query['pairWhitelist'], QuerypairWhitelistArgs, MeshContext>,
  /** null **/
  pairWhitelists: InContextSdkMethod<Query['pairWhitelists'], QuerypairWhitelistsArgs, MeshContext>,
  /** null **/
  pairReserve: InContextSdkMethod<Query['pairReserve'], QuerypairReserveArgs, MeshContext>,
  /** null **/
  pairReserves: InContextSdkMethod<Query['pairReserves'], QuerypairReservesArgs, MeshContext>,
  /** null **/
  tokenomicsParams: InContextSdkMethod<Query['tokenomicsParams'], QuerytokenomicsParamsArgs, MeshContext>,
  /** null **/
  tokenomicsParams_collection: InContextSdkMethod<Query['tokenomicsParams_collection'], QuerytokenomicsParams_collectionArgs, MeshContext>,
  /** null **/
  lpStakingPosition: InContextSdkMethod<Query['lpStakingPosition'], QuerylpStakingPositionArgs, MeshContext>,
  /** null **/
  lpStakingPositions: InContextSdkMethod<Query['lpStakingPositions'], QuerylpStakingPositionsArgs, MeshContext>,
  /** null **/
  vrswStakingPosition: InContextSdkMethod<Query['vrswStakingPosition'], QueryvrswStakingPositionArgs, MeshContext>,
  /** null **/
  vrswStakingPositions: InContextSdkMethod<Query['vrswStakingPositions'], QueryvrswStakingPositionsArgs, MeshContext>,
  /** Access to subgraph metadata **/
  ...
  /** null **/
  pairWhitelist: InContextSdkMethod<Subscription['pairWhitelist'], SubscriptionpairWhitelistArgs, MeshContext>,
  /** null **/
  pairWhitelists: InContextSdkMethod<Subscription['pairWhitelists'], SubscriptionpairWhitelistsArgs, MeshContext>,
  /** null **/
  pairReserve: InContextSdkMethod<Subscription['pairReserve'], SubscriptionpairReserveArgs, MeshContext>,
  /** null **/
  pairReserves: InContextSdkMethod<Subscription['pairReserves'], SubscriptionpairReservesArgs, MeshContext>,
  /** null **/
  tokenomicsParams: InContextSdkMethod<Subscription['tokenomicsParams'], SubscriptiontokenomicsParamsArgs, MeshContext>,
  /** null **/
  tokenomicsParams_collection: InContextSdkMethod<Subscription['tokenomicsParams_collection'], SubscriptiontokenomicsParams_collectionArgs, MeshContext>,
  /** null **/
  lpStakingPosition: InContextSdkMethod<Subscription['lpStakingPosition'], SubscriptionlpStakingPositionArgs, MeshContext>,
  /** null **/
  lpStakingPositions: InContextSdkMethod<Subscription['lpStakingPositions'], SubscriptionlpStakingPositionsArgs, MeshContext>,
  /** null **/
  vrswStakingPosition: InContextSdkMethod<Subscription['vrswStakingPosition'], SubscriptionvrswStakingPositionArgs, MeshContext>,
  /** null **/
  vrswStakingPositions: InContextSdkMethod<Subscription['vrswStakingPositions'], SubscriptionvrswStakingPositionsArgs, MeshContext>,
  /** Access to subgraph metadata **/
  _meta: InContextSdkMethod<Subscription['_meta'], Subscription_metaArgs, MeshContext>
  };

  export type Context = {
      ["graph-test"]: { Query: QuerySdk, Mutation: MutationSdk, Subscription: SubscriptionSdk },
